...
export function chip(chip : Chip){
    return (
        <div class="flex w-min rounded-full h-9 bg-slate-700 text-white border-slate-200 border items-center pr-2">
            <div class="flex justify-center items-center aspect-square h-full rounded-full bg-slate-50 p-1">
                <img class="w-full h-full object-scale-down" src= { chip.icon } alt= { chip.iconAlt }/>
            </div>
